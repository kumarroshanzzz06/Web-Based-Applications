...
<div class="required1"><img src="logo.jpg" alt="Image Not Found" height="100" width="100" align="left"><span style="font-size:35px">GIET , GUNUPUR</span><br><br><span style="font-size:30px">WELCOME BSH</span>
</div>
...
<div class="menu-wrap" >
	<nav class="menu">
	<ul class="clearfix">
			<li><input type="button" value="1st year" onclick="funcall('<?php echo $_SERVER['QUERY_STRING'] ?>+1')"></li>
		</ul> 
...
<div id="last"><h2><a id="home1" href="bshpage.php?BSH" style="color:red;"><abbr title="GO TO HOME PAGE">HOME</abbr></a>&nbsp&nbsp| <a href="logout.php" style="color:red;">Log Out</a>&nbsp&nbsp|&nbsp&nbsp<a href="password.php?BSH" style="color:red;">Change Password</a></h2></div>
<div id="foot">
...
if(isset($_POST['del1']))
{
	...
	if(mysql_num_rows($data)==1)
	{
		...
		$dt="BSH Deleted The Record Of ".$rec[0]." Having Inormation ".$rec[1]." ".$rec[2]." ".$rec[3]." ".$rec[4]." ".$rec[5]." ".$rec[6]." ".$rec[7]." ".$rec[8]." ".$rec[9]." ".$rec[10]." ".$rec[11]." ".$rec[12]." ".$rec[13]." ".$rec[14]." ".$rec[15]." ".$rec[16]." ".$rec[17]." "." On ".$dt."<br>\n";
		fwrite($fp,$dt);
