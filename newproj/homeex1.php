...
<a id="anc1" href="display_info.php?<?php echo $_SERVER['QUERY_STRING'] ?>+a">ALL</a>
<a id="anc2" href="display_info.php?<?php echo $_SERVER['QUERY_STRING'] ?>+1">1st<br>year</a>
<a id="anc3" href="display_info.php?<?php echo $_SERVER['QUERY_STRING'] ?>+2">2nd<br>year</a>
<a id="anc4" href="display_info.php?<?php echo $_SERVER['QUERY_STRING'] ?>+3">3rd<br>year</a>
<a id="anc5" href="display_info.php?<?php echo $_SERVER['QUERY_STRING'] ?>+4">4th<br>year</a>
...
<div class="required1" style="font-family:algerian;"><h2>&nbsp &nbsp &nbsp WELCOME TO <?php $qs=$_SERVER['QUERY_STRING']; echo " $qs"; ?> HOSTEL</h2></div>
...
<form method="post" class="form-style-1" action="displayofficial.php?<?php echo $_SERVER['QUERY_STRING'] ?>" onsubmit="return fun5()">
...
<form method="post" action="displayofficial.php?<?php echo $_SERVER['QUERY_STRING'] ?>" class="form-style-1" onsubmit="return fun7()">
<br>
<input type="text" placeholder="Enter Roll_no" name="name1" style="border-color:indianred;border-radius:5px" id="i1" size="30">
<br> 
<span style="text-align:center;"><h2>OR</h2></span>

<input type="text" placeholder="Enter Regd_no" name="name2" style="border-color:indianred;border-radius:5px" id="i2" size="30">
<br><br>
<input type="submit" style="background:url('submitbutton1.gif');width:25%;height:8%;border-radius:30%;position:absolute;left:17%" value="" name="sub2">
<br>
</form>
</span>
...
if(isset($_POST['del1']))
{
	...
	{
		$n=$n+1;
		$data=mysql_query("select * from stud_hostel_details where rollno='$n1' and hostel_name='$qs' ");
	}
	else
	{
		$o=$o+1;
		$data=mysql_query("select * from stud_hostel_details where rollno='$n1' and regsno='$n2' and hostel_name='$qs' ");
	}
	if(mysql_num_rows($data)==1)
	{
		...
		fwrite($fp,$dt);
		mysql_query("delete from stud_hostel_details where regsno='$n2' and hostel_name='$qs' ");
		}
		if($n==1)
		{
		$rec=mysql_fetch_row($data);
		...
		$dt=$qs." Deleted The Record Of ".$rec[0]." Having Inormation ".$rec[1]." ".$rec[2]." ".$rec[3]." ".$rec[4]." ".$rec[5]." ".$rec[6]." ".$rec[7]." ".$rec[8]." ".$rec[9]." ".$rec[10]." ".$rec[11]." "." On ".$dt."<br>\n";
		fwrite($fp,$dt);
		mysql_query("delete from stud_hostel_details where rollno='$n1' and hostel_name='$qs' ");
		}
		if($o==1)
		{
		$rec=mysql_fetch_row($data);
		...
		$dt=$qs." Deleted The Record Of ".$rec[0]." Having Inormation ".$rec[1]." ".$rec[2]." ".$rec[3]." ".$rec[4]." ".$rec[5]." ".$rec[6]." ".$rec[7]." ".$rec[8]." ".$rec[9]." ".$rec[10]." ".$rec[11]." "." On ".$dt."<br>\n";
		fwrite($fp,$dt);
		mysql_query("delete from stud_hostel_details where rollno='$n1' and regsno='$n2' and hostel_name='$qs'");
		}
